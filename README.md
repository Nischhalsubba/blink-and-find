...
**Branch-aware technical guide for [`agent/optimize-realtime-presence`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence)**

<p><img alt="branch: agent/optimize-realtime-presence" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Foptimize-realtime-presence&color=5965F2&style=flat-square"> <img alt="Next.js" src="https://img.shields.io/static/v1?label=&message=Next.js&color=24292F&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/codespaces/new?ref=agent%2Foptimize-realtime-presence"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/optimize-realtime-presence`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/README.md)
- [`eslint.config.mjs`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/eslint.config.mjs)
...
```mermaid
flowchart TD
    ROOT["blink-and-find / agent/optimize-realtime-presence"]
    ROOT --> P0[".github/"]
    ROOT --> P1["docs/"]
    ROOT --> P2["public/"]
    ROOT --> P3["src/"]
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/public), [`src`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/src) |
| Data | [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/supabase) |
| Quality | [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/.github) |
...
Relevant detected files: [`src/lib/onlineSession.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/lib/onlineSession.ts).
...
Detected data areas: [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/supabase), [`src/lib/supabase.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/lib/supabase.ts), [`supabase/presence_invites.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/presence_invites.sql), [`supabase/schema.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/schema.sql), [`supabase/deferred_invite_rooms.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/deferred_invite_rooms.sql), [`supabase/hardened_online_results.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/hardened_online_results.sql), [`supabase/app_event_logs.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/app_event_logs.sql), [`supabase/production_features.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/production_features.sql), [`supabase/priority8_hardening.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/supabase/priority8_hardening.sql).
...
- [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence/tests)
...
- [`src/lib/analytics.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/lib/analytics.ts)
- [`src/lib/appLogger.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/lib/appLogger.ts)
- [`src/app/telemetry/page.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/app/telemetry/page.tsx)
- [`src/components/TelemetryDashboard.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/components/TelemetryDashboard.tsx)
- [`src/components/AppTelemetry.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/src/components/AppTelemetry.tsx)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/optimize-realtime-presence"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/optimize-realtime-presence/.github/workflows/ci.yml)
...
| Branch | [`agent/optimize-realtime-presence`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence) |
