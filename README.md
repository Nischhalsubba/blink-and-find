...
**Branch-aware technical guide for [`agent/fix-invite-refresh`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh)**

<p><img alt="branch: agent/fix-invite-refresh" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Ffix-invite-refresh&color=5965F2&style=flat-square"> <img alt="Next.js" src="https://img.shields.io/static/v1?label=&message=Next.js&color=24292F&style=flat-square"> <img alt="React" src="https://img.shields.io/static/v1?label=&message=React&color=24292F&style=flat-square"> <img alt="Tailwind CSS" src="https://img.shields.io/static/v1?label=&message=Tailwind%20CSS&color=24292F&style=flat-square"> <img alt="TypeScript" src="https://img.shields.io/static/v1?label=&message=TypeScript&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/codespaces/new?ref=agent%2Ffix-invite-refresh"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/fix-invite-refresh`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/README.md)
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/public), [`src`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/src) |
| Data | [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/supabase) |
| Quality | [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/.github) |
...
Relevant detected files: [`src/lib/onlineSession.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/lib/onlineSession.ts).
...
Detected data areas: [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/supabase), [`src/lib/supabase.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/lib/supabase.ts), [`supabase/presence_invites.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/presence_invites.sql), [`supabase/schema.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/schema.sql), [`supabase/deferred_invite_rooms.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/deferred_invite_rooms.sql), [`supabase/hardened_online_results.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/hardened_online_results.sql), [`supabase/app_event_logs.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/app_event_logs.sql), [`supabase/guest_multiplayer_abuse_guards.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/guest_multiplayer_abuse_guards.sql), [`supabase/production_features.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/production_features.sql), [`supabase/priority8_hardening.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/supabase/priority8_hardening.sql).
...
- [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/fix-invite-refresh/tests)
...
- [`src/lib/analytics.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/lib/analytics.ts)
- [`src/lib/appLogger.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/lib/appLogger.ts)
- [`src/app/telemetry/page.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/app/telemetry/page.tsx)
- [`src/components/TelemetryDashboard.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/components/TelemetryDashboard.tsx)
- [`src/components/AppTelemetry.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/src/components/AppTelemetry.tsx)
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-invite-refresh"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/blink-and-find/blob/agent/fix-invite-refresh/.github/workflows/ci.yml)
