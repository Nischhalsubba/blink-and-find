...
**Branch-aware technical guide for [`main`](https://github.com/Nischhalsubba/blink-and-find/tree/main)**
...
<p>
  <a href="https://github.com/Nischhalsubba/blink-and-find/tree/main"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/blink-and-find/codespaces/new?ref=main"><strong>Open in Codespaces</strong></a>
</p>
...
| Stack | Next.js, React, Tailwind CSS, TypeScript, JavaScript, CSS, HTML |
...
|---|---|
| Interface | [`public`](https://github.com/Nischhalsubba/blink-and-find/tree/main/public), [`src`](https://github.com/Nischhalsubba/blink-and-find/tree/main/src) |
| Data | [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/main/supabase) |
| Quality | [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/main/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/blink-and-find/tree/main/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/blink-and-find/tree/main/.github), [`scripts`](https://github.com/Nischhalsubba/blink-and-find/tree/main/scripts) |
...
Relevant detected files: [`src/lib/onlineSession.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/lib/onlineSession.ts), [`supabase/migrations/20260716025133_restore_host_managed_ai_authorization.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/migrations/20260716025133_restore_host_managed_ai_authorization.sql).
...
Detected data areas: [`supabase`](https://github.com/Nischhalsubba/blink-and-find/tree/main/supabase), [`scripts/check-supabase-advisors.mjs`](https://github.com/Nischhalsubba/blink-and-find/blob/main/scripts/check-supabase-advisors.mjs), [`src/lib/supabase.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/lib/supabase.ts), [`supabase/presence_invites.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/presence_invites.sql), [`supabase/schema.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/schema.sql), [`supabase/deferred_invite_rooms.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/deferred_invite_rooms.sql), [`supabase/hardened_online_results.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/hardened_online_results.sql), [`supabase/app_event_logs.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/app_event_logs.sql), [`supabase/guest_multiplayer_abuse_guards.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/guest_multiplayer_abuse_guards.sql), [`supabase/production_features.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/production_features.sql), [`supabase/priority8_hardening.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/priority8_hardening.sql), [`supabase/migrations/20260716025133_restore_host_managed_ai_authorization.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/migrations/20260716025133_restore_host_managed_ai_authorization.sql).
...
Relevant detected files: [`supabase/migrations/20260729093000_enable_safe_multiplayer_cleanup_cron.sql`](https://github.com/Nischhalsubba/blink-and-find/blob/main/supabase/migrations/20260729093000_enable_safe_multiplayer_cleanup_cron.sql).
...
- [`tests`](https://github.com/Nischhalsubba/blink-and-find/tree/main/tests)
...
- [`src/lib/analytics.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/lib/analytics.ts)
- [`src/lib/appLogger.ts`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/lib/appLogger.ts)
- [`src/app/telemetry/page.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/app/telemetry/page.tsx)
- [`src/components/TelemetryDashboard.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/components/TelemetryDashboard.tsx)
- [`src/components/AppTelemetry.tsx`](https://github.com/Nischhalsubba/blink-and-find/blob/main/src/components/AppTelemetry.tsx)
...
- [`.github/workflows/apply-interactive-readme.yml`](https://github.com/Nischhalsubba/blink-and-find/blob/main/.github/workflows/apply-interactive-readme.yml)
- [`.github/workflows/ci.yml`](https://github.com/Nischhalsubba/blink-and-find/blob/main/.github/workflows/ci.yml)
