...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/supabase-authoritative-results`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/supabase-authoritative-results). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/supabase-authoritative-results"]
