...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/optimize-realtime-presence`](https://github.com/Nischhalsubba/blink-and-find/tree/agent/optimize-realtime-presence). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/optimize-realtime-presence"]
