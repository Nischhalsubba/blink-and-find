...
const tiles = [
  { value: "42", left: 770, top: 122, rotate: -8, color: "#7c3aed" },
  { value: "19", left: 930, top: 106, rotate: 7, color: "#06b6d4" },
  { value: "73", left: 1012, top: 250, rotate: -10, color: "#ec4899" },
  { value: "8", left: 790, top: 360, rotate: 9, color: "#f97316" },
  { value: "55", left: 955, top: 454, rotate: -5, color: "#22c55e" },
];
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: "absolute", left: 58, top: 54, right: 58, bottom: 54, borderRadius: 42, border: "2px solid rgba(255,255,255,0.88)", background: "linear-gradient(135deg, rgba(255,255,255,0.88), rgba(255,255,255,0.66))", boxShadow: "0 28px 85px rgba(124,58,237,0.22)" }} />
        ...
        <div style={{ position: "absolute", left: 790, top: 300, width: 220, height: 220, borderRadius: 999, background: "#7c3aed", color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 38, fontWeight: 900, boxShadow: "0 24px 52px rgba(124,58,237,0.35)" }}>
          FIND 42
        </div>
      </div>
    ),
