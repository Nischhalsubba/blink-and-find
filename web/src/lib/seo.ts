...
export const ROUTES = [
  { path: "/", label: "Play Blink & Find", description: "Start a quick number hunting game or create an online room for friends." },
  { path: "/daily", label: "Daily Challenge", description: DAILY_DESCRIPTION },
  { path: "/challenge", label: "Shared Challenge", description: CHALLENGE_DESCRIPTION },
  { path: "/time-attack", label: "Time Attack", description: TIME_ATTACK_DESCRIPTION },
  { path: "/streak", label: "Streak Mode", description: STREAK_DESCRIPTION },
  { path: "/comfort", label: "Comfort Mode", description: COMFORT_DESCRIPTION },
  { path: "/zen", label: "Zen Mode", description: ZEN_DESCRIPTION },
  { path: "/tutorial", label: "Interactive Tutorial", description: TUTORIAL_DESCRIPTION },
  { path: "/practice", label: "Practice Mode", description: PRACTICE_DESCRIPTION },
  { path: "/stats", label: "Personal Stats", description: STATS_DESCRIPTION },
  { path: "/leaderboard", label: "Leaderboard", description: LEADERBOARD_DESCRIPTION },
  { path: "/profile", label: "Player Profile", description: PROFILE_DESCRIPTION },
  { path: "/tips", label: "Tips", description: TIPS_DESCRIPTION },
  { path: "/modes", label: "Game Modes", description: MODES_DESCRIPTION },
  { path: "/faq", label: "FAQ", description: FAQ_DESCRIPTION },
  { path: "/rules", label: "Game Rules", description: RULES_DESCRIPTION },
  { path: "/online", label: "Online Play", description: "Create or join an online room to play with a friend on another device." },
  { path: "/history", label: "Online History", description: "View completed online rooms, winners, leaderboard entries, and round results." },
];
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        step: [
          { "@type": "HowToStep", name: "Memorize the target", text: "A target number appears briefly before the round starts." },
          { "@type": "HowToStep", name: "Find the hidden number", text: "After the target hides, tap the matching number on the scattered board." },
          { "@type": "HowToStep", name: "Avoid wrong taps", text: "Each wrong tap adds penalty time to your score." },
          { "@type": "HowToStep", name: "Win by fastest total time", text: "The player with the lowest total time after all rounds wins." },
        ],
      },
    ],
  };
